...
module.exports = {
    ...
    isRouteDeployed: function(derpConfigData, routeName) {
        return derpConfigData.routes[routeName].url ? true : false;
    },

    isAnyRouteDeployed: function(derpConfigData) {
        for (var route in derpConfigData.routes) {
            if (this.isRouteDeployed(derpConfigData, route))
                return true;
        }
