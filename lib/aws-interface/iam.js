...
module.exports = {
    ...
    deleteIAMRole: (derpConfigData, params) => {
        return getIAM(derpConfigData).deleteRole(params).promise();
    },

    deleteIAMRolePolicy: (derpConfigData, params) => {
        return getIAM(derpConfigData).deleteRolePolicy(params).promise();
    }
}
