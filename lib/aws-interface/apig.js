...
module.exports = {
    ...
    deleteResource: (derpConfigData, params) => {
        return getApig(derpConfigData).deleteResource(params).promise();
    },

    deleteRestApi: (derpConfigData, params) => {
        return getApig(derpConfigData).deleteRestApi(params).promise();
    }
}
